  ...
  return (
    <div className={fullscreen ? "fixed inset-0 z-50 bg-[#222733] flex" : "min-h-screen w-full bg-[#222733] flex"}>
      ...
      <div className="hidden md:flex flex-col items-center bg-[#23272f] border-r border-[#34394b] py-4 px-2 w-14">
        <a href="/python-compiler" className="mb-4 p-2 rounded bg-[#2d3140]">
      ...
      <div className="md:hidden flex items-center justify-around bg-[#23272f] border-b border-[#34394b] py-2 fixed bottom-0 left-0 right-0 z-10">
        <a href="/python-compiler" className="p-2 rounded bg-[#2d3140]">
      ...
      <div className="flex-1 flex flex-col h-screen md:h-screen pb-14 md:pb-0">
        ...
        <div className="flex flex-wrap items-center bg-[#23272f] border-b border-[#34394b] px-2 md:px-4 py-2 h-auto md:h-14">
          <div className="flex items-center gap-2 mb-2 md:mb-0">
            <FaPython className="w-6 h-6 md:w-7 md:h-7 text-[#3472A6]" />
            <span className="text-white font-bold text-base md:text-lg">Python Online Compiler</span>
          </div>
          <div className="hidden md:flex flex-1 justify-center">
            <div className="bg-[#23272f] border border-[#34394b] rounded-t px-4 py-1 text-[#b3b9c5] text-sm font-mono">main.py</div>
          </div>
          <div className="flex flex-wrap items-center gap-2 ml-auto">
            <button 
              onClick={runCode} 
              disabled={isLoading} 
              className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold px-3 md:px-4 py-1 rounded transition-all focus:outline-none disabled:opacity-60 flex items-center gap-1 text-sm md:text-base"
            >
              <svg width="16" height="16" fill="none" viewBox="0 0 20 20"><path d="M7 6l6 4-6 4V6z" fill="#fff"/></svg>
            ...
            >Share</button>
            <button onClick={() => setCode("")} className="bg-[#34394b] hover:bg-[#2d3140] text-[#b3b9c5] px-2 md:px-3 py-1 rounded text-xs md:text-sm">Clear</button>
